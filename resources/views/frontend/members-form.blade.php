    ...
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          ...
          <div class="col-md-9">
            @if($action == 'update')
              <div class="form-control-static r-text">{{ $requester->username }}</div>
            @else
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <div class="col-md-9">
            ...
            <span class="help-block r-text">Fill in password field only when you want to update the password</span>
          </div>
        </div>
      </div>
    </div>

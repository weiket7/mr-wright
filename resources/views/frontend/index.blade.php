        ...
        <ul class="services-list clearfix page-margin-top">
          <li>
            <a href="{{url($frontend['contents']['service_column1_link'])}}">
              <img src="{{url('images/frontend/'.$frontend['contents']['service_column1_image'])}}" alt="">
            </a>
          ...
          <li>
            <a href="{{url($frontend['contents']['service_column2_link'])}}">
              <img src="{{url('images/frontend/'.$frontend['contents']['service_column2_image'])}}" alt="">
            </a>
          ...
          <li>
            <a href="{{url($frontend['contents']['service_column3_link'])}}">
              <img src="{{url('images/frontend/'.$frontend['contents']['service_column3_image'])}}" alt="">
            </a>

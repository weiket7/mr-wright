...
class AccessSeeder extends Seeder
{
  public function run()
  {
    ...
    DB::table('access')->insert(['access_id'=>25, 'name'=>'payment-method', 'type'=>AccessType::Module]);
    DB::table('access')->insert(['access_id'=>26, 'name'=>'membership', 'type'=>AccessType::Module]);
  }
}

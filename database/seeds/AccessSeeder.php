...
class AccessSeeder extends Seeder
{
  public function run()
  {
    ...
    DB::table('access')->insert(['access_id'=>4, 'name'=>'ticket_respond']);
    DB::table('access')->insert(['access_id'=>5, 'name'=>'ticket_complete']);
    DB::table('access')->insert(['access_id'=>6, 'name'=>'ticket_invoice']);
    ...
    DB::table('access')->insert(['access_id'=>17, 'name'=>'system']);
    DB::table('access')->insert(['access_id'=>18, 'name'=>'skill']);
    DB::table('access')->insert(['access_id'=>19, 'name'=>'role']);
    DB::table('access')->insert(['access_id'=>20, 'name'=>'access']);
  }
}
